...
const config = {
  ...
  favicon: '//static.hosimiyasio.com/image/favicon.jpg?x-oss-process=style/favicon',
  ...
  themeConfig:
    ...
    ({
      navbar: {
        ...
        logo: {
          alt: 'Site Logo',
          src: '//static.hosimiyasio.com/image/navbar_icon.ico',
        },
        items: [
      ...
      footer: {
        ...
        <br><a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=32081202000264" target="_blank" rel="noopener" style="text-decoration: none;color:var(--ifm-footer-link-color)!important">苏公网安备 32081202000374号</a><br>
